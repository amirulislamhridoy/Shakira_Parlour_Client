    ...
    return (
        <div className='lg:flex items-center lg:pt-8 pt-0 pb-10 lg:px-2 px-5'>
            <div className='flex-1 lg:mb-0 mb-5'>
                <h1 className='text-4xl lg:text-5xl font-bold leading-tight'>BEAUTY SALON <br /> FOR EVERY WOMEN</h1>
            ...
            <div className=''>
                <img className='mx-auto lg:max-w-[484px] lg:max-h-[478px] rounded-xl' src={bannerImg} alt="Girl Photo" />
            </div>
        </div>
    );
};
